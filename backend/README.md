...
## Project Structure
    ...
    ├── travel_app_concept_29966  # Django project configurations
...
1. Clone this repo and `cd travel_app_concept_29966`
...
2. Clone this repo and `cd travel_app_concept_29966`
